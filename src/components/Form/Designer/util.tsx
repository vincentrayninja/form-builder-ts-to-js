...
export function filter(root: CellData, type): CellData[];
export function filter(
  root: CellData,
...
export function reducer(state, action: ReducerActionProps): CellData {
  if (!action.type) {
    return state;
  }
  if (action.type === "INIT") {
...
export function active(root: CellData, id): void {
...
export function createBasicWidgetInstance(type): CellData {
