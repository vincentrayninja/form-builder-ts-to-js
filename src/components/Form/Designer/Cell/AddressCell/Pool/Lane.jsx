...
export const Lane = forwardRef(({ cellDataList, direction, className, span = 24, customCells, location, }, ref) => {
    ...
    const cells = useMemo(() => {
        return cellDataList.map((child, index) => {
            ...
            return instanceDispatch === null ? (<DnDCell {...props} index={index}/>) : (<Cell {...props}/>);
        });
